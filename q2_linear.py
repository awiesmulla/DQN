...
class Linear(DQN):
    ...
    def add_placeholders_op(self):
        ...
        self.s = tf.placeholder("uint8", shape=[None, img_height, img_width, 
                                                       nchannels * self.config.state_history], 
                                name='state')
        self.a = tf.placeholder("int32", shape=[None], name='action')
        self.r = tf.placeholder("float32", shape=[None], name='reward')
        self.sp = tf.placeholder("uint8", shape=[None, img_height, img_width, 
                                                        nchannels * self.config.state_history], 
                                 name='next_state')
        self.done_mask = tf.placeholder("bool", shape=[None], name='done_mask')
        self.lr = tf.placeholder("float32", name='learning_rate')   
        pass
        ##############################################################
        ######################## END YOUR CODE #######################
    ...
    def get_q_values_op(self, state, scope, reuse=False):
        ...
        with tf.variable_scope(scope, reuse):
            ...
            out = layers.Dense(units=num_actions, activation=None)(x)
        pass
        ##############################################################
        ######################## END YOUR CODE #######################
        return out
    ...
    def add_update_target_op(self, q_scope, target_q_scope):
        ...
        assgin_op = [tf.assign(target_q_scope_variable[i], q_scope_variable[i]) 
                     for i in range(len(q_scope_variable))]
    ...
    def add_loss_op(self, q, target_q):
        ...
        pass
        ##############################################################
        ######################## END YOUR CODE|CHECK Q and Q_SAMP#######################
